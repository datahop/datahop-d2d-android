...
import static network.datahop.localfirst.net.ble.Constants.CHARACTERISTIC_DATAHOP_DIRECT;
import static network.datahop.localfirst.net.ble.Constants.CHARACTERISTIC_DATAHOP_STRING;
import static network.datahop.localfirst.net.ble.Constants.CLIENT_CONFIGURATION_DESCRIPTOR_SHORT_ID;
...
public class BluetoothUtils {
    ...
    public static List<BluetoothGattCharacteristic> findCharacteristics(BluetoothGatt bluetoothGatt, UUID SERVICE_UUID,List<Group> groups) {
        ...
        {
            String CHARACTERISTIC_UUID = nameUUIDFromBytes(group.getName().getBytes()).toString();
            for (BluetoothGattCharacteristic characteristic : characteristicList) {
               // G.Log(TAG,"Characteristic "+characteristic.getUuid().toString()+" "+CHARACTERISTIC_UUID);
    ...
    public static boolean matchAnyCharacteristic(UUID SERVICE_UUID,List<Group> groups) {
